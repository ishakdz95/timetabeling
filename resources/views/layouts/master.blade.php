...
<div id="app" class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
    ...
    <div class="app-main">
        ...
        {{-- here where the navbar is included, from layouts folder --}}
        @include('layouts.sidebar')
        {{-- here where the main is included, from layouts folder
        main-content contine the main-section where the page content will displayed--}}
