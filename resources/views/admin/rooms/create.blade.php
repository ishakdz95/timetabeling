...
@section('main-section')
    <div class="card-body"><h5 class="card-title text-site">New Room</h5>
        <form method="POST" action="{{route('admin.rooms.store')}}">
            @csrf
            <div class="position-relative form-group">
                <label class="text-light" for="validationCustom01">Room Name</label>
                <input type="text" name="code" class="form-control" id="validationCustom01" placeholder="course name" required>
            </div>
            <div class="position-relative form-group">
                <label class="text-light" for="exampleSelect" class="" required>Type Of Room:</label>
